...
<section class="text-center mx-5 lg:mx-auto my-10 lg:w-1/2 text-white">
    ...
    <form action="{{ route('contact.store') }}" method="post" class="w-2/3 mx-auto text-left text-white">
        @csrf
        ...
        <div class="mb-4">
            <label class="block text-sm font-bold mb-2" for="subject">
                Subject
            </label>
        ...
        <div class="mb-4">
            ...
            <textarea name="message" id="message" rows="8" class="input">{{ old('message') }}</textarea>
        </div>
        <div class="mb-4">
